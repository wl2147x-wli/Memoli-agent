...
class Tool(Plugin):
    ...
    def _build_tool_kwargs(self, kwargs: dict):
        ...
        return {
            ...
            # 用于晨间新闻工具
            "morning_news_api_key": kwargs.get("morning_news_api_key", ""),   # API 密钥
            ...
            "sms_apikey": kwargs.get("sms_apikey", ""),  # 短信宝
            # 用于 stt 工具
            "stt_api_key": kwargs.get("stt_api_key", ""),  # 天蓝色的
            "stt_api_region": kwargs.get("stt_api_region", ""),  # 天蓝色的
            "stt_recognition_language": kwargs.get("stt_recognition_language", "zh-CN"),  # 识别的语言类型 部分：en-US ja-JP ko-KR yue-CN zh-CN
            # 用于 tts 工具
            "tts_api_key": kwargs.get("tts_api_key", ""),  # 天蓝色的
            "tts_api_region": kwargs.get("tts_api_region", ""),  # 天蓝色的
            ...
            # 用于视觉工具
            "caption_api_key": kwargs.get("caption_api_key", ""),  # 阿里 dashscope apikey
            # 用于浏览器工具
