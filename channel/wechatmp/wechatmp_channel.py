...
# 如果使用 SSL，请取消注释以下行，并修改证书路径。
# 从 cheroot.server 导入 HTTPServer
# 从 cheroot.ssl.builtin 导入内置 SSLAdapter
# HTTPServer.ssl_adapter = 内置SSLAdapter(
#         证书='/ssl/cert.pem',
