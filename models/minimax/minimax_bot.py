...
class MinimaxBot(Bot):
    ...
    def call_with_tools(self, messages, tools=None, stream=False, **kwargs):
        ...
        try:
            ...
            # 添加 Reasoning_split=True 以获得更好的思维控制（M2.1 功能）
            # 这将思考内容分离到reasoning_details字段中
        ...
        try:
            ...
            for line in response.iter_lines():
                ...
                if "content" in delta and delta["content"]:
                    ...
                    # 生成 OpenAI 格式增量（用于 agent_stream.py 兼容性）
                    yield {
                        "choices": [{
                            "index": 0,
                            "delta": {
            ...
            # 使用 finish_reason 生成最终块（OpenAI 格式）
            yield {
                "choices": [{
                    "index": 0,
                    "delta": {},
