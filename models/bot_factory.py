...
def create_bot(bot_type):
    ...
    if bot_type == const.BAIDU:
        ...
        # 从 models.baidu.baidu_unit_bot 导入 BaiduUnitBot
        # 返回BaiduUnitBot()
    ...
    elif bot_type in (const.OPENAI, const.CHATGPT, const.CUSTOM) or bot_type.startswith("custom:"):  # OpenAI 兼容 API
    ...
    elif bot_type == const.ZHIPU_AI or bot_type == "glm-4":  # 保留“glm-4”以实现向后兼容性
