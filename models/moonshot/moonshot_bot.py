...
class MoonshotBot(Bot):
    ...
    def call_with_tools(self, messages, tools=None, stream: bool = False, **kwargs):
        ...
        try:
            ...
            # Kimi Coding Plan 和 Kimi K3 是永远思考的模型。 K3
            # 用顶级的reasoning_effort控制推理，而不是思考。
            if not self._is_kimi_coding_plan and self._is_kimi_k3_model(model):
                reasoning_effort = kwargs.get("reasoning_effort")
                if reasoning_effort:
                    request_body["reasoning_effort"] = reasoning_effort
            # 对于常规 Kimi K2/K1.5 型号，请尊重enable_thinking
            # 配置从agent_bridge通过thinking参数传递。
    ...
    def _handle_stream_response(self, request_body: dict):
        ...
        try:
            ...
            for line in response.iter_lines():
                ...
                # 处理“data: {...}”和“data:{...}”（Kimi Coding Plan 省略空格）
    ...
    def _handle_sync_response(self, request_body: dict):
        ...
        try:
            ...
            # Kimi K3需要在多回合中保留reasoning_content
            # 当助理轮流思考活跃时的对话。
    ...
    def _convert_messages_to_openai_format(self, messages):
        ...
        for msg in messages:
            ...
            if role == "user":
                ...
                # Kimi API 需要助理消息中的 Reasoning_content
                # 当那个回合的思维活跃时。的存在
                # Reasoning_parts 意味着思考正在进行，所以总是往返。
                if reasoning_parts:
