const translations: Record<string, Record<string, string>> = {
  zh: {
    ...
    models_cap_chat_fallback_sub: '当主模型重试次数用尽仍然失败时，自动切换到兜底模型完成本轮回复',
    models_chat_fallback_enable: '启用兜底模型',
    models_chat_fallback_incomplete: '启用兜底需要同时选择厂商和模型',
  ...
  en: {
    ...
    models_cap_chat_fallback_sub: 'When the main model still fails after exhausting its retries, automatically switch to the fallback model to finish the reply',
    models_chat_fallback_enable: 'Enable the fallback model',
    models_chat_fallback_incomplete: 'Pick both a provider and a model to enable the fallback',
...
// 首次运行默认：遵循操作系统语言，因此 zh-* 系统以中文启动
// 和其他人都用英语。一旦用户选择了一种语言，它就会被保留
// 在cow_lang 中并且总是获胜。当区域设置未知时，返回“en”。
