...
# 限制我们跟踪的重定向次数；每一跳的目标都会重新经过
# SSRF 防护校验，因此公共 URL 无法把我们跳转到内部地址。
MAX_REDIRECTS = 10
...
class WebFetch(BaseTool):
    ...
    def execute(self, args: Dict[str, Any]) -> ToolResult:
        ...
        # SSRF 防护：在发出任何请求之前，
        # 先拒绝那些解析到 private/loopback/link-local 或云元数据地址的 URL。
        try:
