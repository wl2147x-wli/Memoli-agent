...
OPEN_AI = "openAI"
OPENAI = "openai"
CHATGPT = "chatGPT"  # OPENAI 的旧别名，保留用于向后兼容
BAIDU = "baidu"
QIANFAN = "qianfan"
XUNFEI = "xunfei"
...
LINKAI = "linkai"
CLAUDEAPI= "claudeAPI"
QWEN = "qwen"  # 旧别名，实际上路由到 DashscopeBot
QWEN_DASHSCOPE = "dashscope"  # Qwen 通过 DashScope
GEMINI = "gemini" 
ZHIPU_AI = "zhipu"  
MOONSHOT = "moonshot"
MiniMax = "minimax"
DEEPSEEK = "deepseek"
MIMO = "mimo"  # 小米MiMo
CUSTOM = "custom"  # 自定义 OpenAI 兼容 API，bot_type 不会在模型更改时自动切换
...
CLAUDE_35_SONNET = "claude-3-5-sonnet-latest"  # “最新”标签始终指向最新版本
CLAUDE_35_SONNET_1022 = "claude-3-5-sonnet-20241022"  # 固定到特定版本的过时名称
CLAUDE_35_SONNET_0620 = "claude-3-5-sonnet-20240620"
CLAUDE_4_OPUS = "claude-opus-4-0"
CLAUDE_FABLE_5_1 = "claude-fable-5-1"    # 克劳德寓言5.1-替代克劳德5旗舰
CLAUDE_FABLE_5 = "claude-fable-5"        # 克劳德寓言5-另类克劳德5旗舰
CLAUDE_4_8_OPUS = "claude-opus-4-8"      # Claude Opus 4.8 - 代理推荐模型
CLAUDE_4_7_OPUS = "claude-opus-4-7"      # 克劳德作品 4.7
CLAUDE_4_6_OPUS = "claude-opus-4-6"      # 克劳德作品 4.6
CLAUDE_4_SONNET = "claude-sonnet-4-0"    # 克劳德十四行诗 4.0
CLAUDE_4_5_SONNET = "claude-sonnet-4-5"  # Claude Sonnet 4.5 - 代理推荐模型
CLAUDE_4_6_SONNET = "claude-sonnet-4-6"  # Claude Sonnet 4.6 - 代理推荐模型
CLAUDE_SONNET_5 = "claude-sonnet-5"      # Claude Sonnet 5 - 平衡的 Claude 5 旗舰
CLAUDE_OPUS_5 = "claude-opus-5"          # Claude Opus 5 - Claude 默认旗舰型号

# 双子座（谷歌）
GEMINI_PRO = "gemini-1.0-pro"
GEMINI_15_flash = "gemini-1.5-flash"
GEMINI_15_PRO = "gemini-1.5-pro"
GEMINI_20_flash_exp = "gemini-2.0-flash-exp"  # “-exp”模型是实验性的，将被逐步淘汰
GEMINI_20_FLASH = "gemini-2.0-flash"  # 稳定发布
GEMINI_25_FLASH_PRE = "gemini-2.5-flash-preview-05-20"
GEMINI_25_PRO_PRE = "gemini-2.5-pro-preview-05-06"
GEMINI_3_FLASH_PRE = "gemini-3-flash-preview"  # Gemini 3 Flash预览版-代理推荐机型
GEMINI_3_PRO_PRE = "gemini-3-pro-preview"  # Gemini 3 Pro 预览
GEMINI_31_PRO_PRE = "gemini-3.1-pro-preview"  # Gemini 3.1 Pro预览版-代理推荐机型
GEMINI_31_FLASH_LITE_PRE = "gemini-3.1-flash-lite-preview"  # Gemini 3.1 Flash Lite 预览版 - 代理商推荐型号
GEMINI_35_FLASH = "gemini-3.5-flash"  # 双子座3.5闪存
GEMINI_36_FLASH = "gemini-3.6-flash"  # 双子座3.6闪存
GEMINI_37_FLASH = "gemini-3.7-flash"  # Gemini 3.7 Flash-代理推荐型号（默认）
...
GPT_54 = "gpt-5.4"  # GPT-5.4 - 代理推荐模型
GPT_54_MINI = "gpt-5.4-mini"
GPT_54_NANO = "gpt-5.4-nano"
GPT_55 = "gpt-5.5"  # GPT-5.5 - 顶级（昂贵），非默认
GPT_56_LUNA = "gpt-5.6-luna"    # GPT-5.6 Luna - GPT 默认旗舰型号
GPT_56_TERRA = "gpt-5.6-terra"  # GPT-5.6 泰拉
GPT_56_SOL = "gpt-5.6-sol"      # GPT-5.6 Sol - 最高智能，更高延迟
O1 = "o1-preview"
O1_MINI = "o1-mini"
WHISPER_1 = "whisper-1"
TTS_1 = "tts-1"
...
# 深度搜索
DEEPSEEK_CHAT = "deepseek-chat"  # DeepSeek-V3聊天模型
DEEPSEEK_REASONER = "deepseek-reasoner"  # DeepSeek-R1模型
DEEPSEEK_V4_FLASH = "deepseek-v4-flash"  # DeepSeek V4 Flash-默认推荐（思考+工具调用）
DEEPSEEK_V4_PRO = "deepseek-v4-pro"  # DeepSeek V4 Pro - 在复杂任务上更强（思考+工具调用）
DEEPSEEK_V4_FLASH_VISION_EXP = "deepseek-v4-flash-vision-exp"  # DeepSeek V4 Flash 视觉（实验性、多模式）

# 百度千帆/ERNIE
ERNIE_5_1 = "ernie-5.1"  # ERNIE 5.1-默认推荐，最新旗舰
ERNIE_5 = "ernie-5.0"  # 厄尼5.0
ERNIE_X1_1 = "ernie-x1.1"  # ERNIE X1.1 - 注重推理、多模式
...
QWEN_MAX = "qwen-max"
QWEN_LONG = "qwen-long"
QWEN3_MAX = "qwen3-max"  # Qwen3 Max-代理商推荐机型
QWEN35_PLUS = "qwen3.5-plus"  # Qwen3.5 Plus - Omni 模型（MultiModalConversation）
QWEN36_PLUS = "qwen3.6-plus"  # Qwen3.6 Plus - Omni 模型（MultiModalConversation）
QWEN37_PLUS = "qwen3.7-plus"  # Qwen3.7 Plus - Omni 模型（MultiModalConversation）
QWEN37_MAX = "qwen3.7-max"  # Qwen3.7 Max-代理推荐机型
QWEN38_MAX = "qwen3.8-max"  # Qwen3.8 Max - 原生工作模型（多模式端点）
QWEN38_FLASH = "qwen3.8-flash"  # Qwen3.8 Flash - Agent推荐模型（默认），1M上下文/128K输出（MultiModalConversation）
QWQ_PLUS = "qwq-plus"

# 最小最大
MINIMAX_M3 = "MiniMax-M3"  # MiniMax M3 - 最新（默认）
MINIMAX_M2_7 = "MiniMax-M2.7"  # 迷你最大M2.7
MINIMAX_M2_7_HIGHSPEED = "MiniMax-M2.7-highspeed"  # MiniMax M2.7 高速
MINIMAX_TEXT_01 = "MiniMax-Text-01"  # MiniMax 多模式（视觉）
MINIMAX_ABAB6_5 = "abab6.5-chat"  # 迷你最大abab6.5

# GLM（智普AI）
GLM_5_3_FLASH = "glm-5.3-flash"  # GLM-5.3 Flash - Agent推荐型号（默认），1M上下文/128K输出
GLM_5_3 = "glm-5.3"  # GLM-5.3 - 代理推荐模型
GLM_5_2 = "glm-5.2"  # GLM-5.2
GLM_5_1 = "glm-5.1"  # GLM-5.1
GLM_5_TURBO = "glm-5-turbo"  # GLM-5-涡轮
GLM_5 = "glm-5"  # GLM-5
GLM_5V_TURBO = "glm-5v-turbo"  # 智浦多式联运（远景）
GLM_4 = "glm-4"
...
GLM_4_7 = "glm-4.7"  # GLM-4.7 - 代理推荐模型

# 基米（登月）
MOONSHOT = "moonshot"
KIMI_K3 = "kimi-k3"  # Kimi K3-代理推荐型号（默认）
KIMI_K2_7_CODE = "kimi-k2.7-code"  # 基米K2.7代码
KIMI_K2_7_CODE_HIGHSPEED = "kimi-k2.7-code-highspeed"  # 基米K2.7码高速
KIMI_K2 = "kimi-k2"
KIMI_K2_5 = "kimi-k2.5"
KIMI_K2_6 = "kimi-k2.6"
...
MIMO_V2_5 = "mimo-v2.5"              # MiMo V2.5 - 多模式（文本/图像/音频/视频）
MIMO_V2_PRO = "mimo-v2-pro"          # 小米手机V2 Pro
MIMO_V2_OMNI = "mimo-v2-omni"        # MiMo V2 Omni - 多式联运
MIMO_V2_FLASH = "mimo-v2-flash"      # MiMo V2 闪存 - 高速
...
# 配置中缺少 `model` 时的后备模型。保持同步
# config-template.json 因此没有显式模型的配置行为相同
# 作为全新安装。
